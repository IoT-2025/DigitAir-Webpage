...
import { Card, Canvas3D, ImageSlider, CardGrid } from "./index";
    ...
    return (
        <>
            <section id='architettura' className="z-0 flex flex-col gap-[200px] md:gap-0 items-center justify-center w-full h-full px-10 pb-5 sm:px-0 scroll-mt-[100px]">
                ...
                <div className="flex flex-col-reverse items-center justify-center lg:gap-16 gap-16 w-full 2xl:h-full h-[500px] lg:flex-row ">
            ...
            <section id='tecnologie' className="z-0 flex flex-col gap-[200px] md:gap-0 items-center justify-center w-full h-full px-10 pb-12 sm:px-0 scroll-mt-[125px]">
                ...
                <section id="funzionalita" className="z-0 flex flex-col gap-[200px] lg:pt-0 pt-20 sm:gap-0 items-center justify-center w-full h-full px-10 pb-12 sm:px-0 scroll-mt-[125px]">
                    ...
                    <div className="flex flex-col-reverse items-center justify-center w-full 2xl:h-full h-[500px] pb-12 pt-18 lg:flex-row">
                        <div className="lg:flex items-center justify-center w-1/2 hidden h-full">
                            <ImageSlider/>
                        </div>
