...
const ImageSlider = () => {
  ...
  return (
    <div className="max-w-4xl mt-10 p-4">
      <div className="relative bg-gray-900 rounded-xl overflow-hidden shadow-2xl">
        ...
        <button 
          ...
          className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all duration-300 backdrop-blur-sm border border-white/20 hover:scale-110"
        >
          <ChevronLeft size={24} />
        </button>
        ...
        <button 
          onClick={goToNext}
          className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all duration-300 backdrop-blur-sm border border-white/20 hover:scale-110"
        >
      ...
      <div className="mt-4 text-center">
        <p className="text-secondary mb-2 italic">
